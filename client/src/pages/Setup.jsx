...
export default function Setup({candidate}) {
  const navigate = useNavigate();
  const [role , setRole] = useState('MERN stack developer');
  cosnt [selectedType , setSelectedType] = useState('text');
  ...
  return(
    <div className="setup-container">
      <h2>Start a New Interview</h2>
       ...
       <input value={role} onChange={(e) => setRole(e.target.value)}   className="setup-input" /> 
